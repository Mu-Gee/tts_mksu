...
function LecturerLogin() {
  ...
  return (
    <div className="LecturerLogin-container">
      <h1 className="LecturerLogin-header">Lecturer Login</h1>
      <div>
        <label htmlFor="name">
          <svg
            width="1em"
      ...
      <div>
        <button onClick={handleLogin} className="LecturerLogin-button">
          Log In
        </button>
      </div>
      <div>
        <Link to="/lcsignup" className="LecturerLogin-link">
